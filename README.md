...
- experiment_configuration2.js: the code of the experiment you want to run (the downloaded file contains just a mock).

For running an experiment, you need to edit experiment_configuration2.js and then run the html-page.
