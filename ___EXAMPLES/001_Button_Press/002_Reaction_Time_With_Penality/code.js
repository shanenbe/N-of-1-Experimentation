...
Nof1.SET_SEED(SEED);
    ...
    let experiment_configuration_function = (writer) => { return {
        ...
        measurement: Nof1.Reaction_time_with_penalty(Nof1.keys(["1", "2", "3", "9"]), TIME_PENALTY_SECONDS),
        ...
        task_configuration:    (t) => {
            ...
            t.do_print_error_message = (given_answer) => {
                writer.clear_stage();
                writer.clear_error();
                writer.print_html_on_error("<h1>Invalid answer: " + given_answer + "<br>After " + TIME_PENALTY_SECONDS + " seconds you can press [Enter] to redo the task.");
            };
