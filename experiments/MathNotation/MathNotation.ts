// import {AUTOMATA_OUTPUT_WRITER_TAGS} from "../../modules/Books/Automata_IO";
//
// SET_SEED("42");
//
...
//             // ,
//             // "You have to do some manual computations in this experiment, but don't be scared, it is really not hard.\n\n" +
//             // "You have to remember that 2²=4"
//         ],
//         pre_run_instruction:
//             "Please, put your fingers now on the keys [1]-[3]. These are the only possible inputs in a task.\n\n" +
...
//                     t.html_string_with_cmd(
//                         // "<p>$$\\sqrt[{{\\sqrt[{2 + {1^3}}\\;]{64\\;}} - {{(\\frac{{\\frac{8}{2}}}{4}})^2}}\\;]{64\\;}$$</p>",
//                         "<p>$$" + term.mathjax_code_string() + "$$</p><p>" +  term.mathjax_code_string() + "</p> <p>" + term.functional_code_string() + "</p>",
//                         ()=> {
//                             // @ts-ignore
//                             MathJax.typeset();
//                         }
//                     );
//                 } else {
//                     t.code_string(term.functional_code_string())
//                 }
//
//                 t.expected_answer = "" + term.result;
//
//                 t.after_task_html_string_constructor(() => "<H1>Expected: " + t.expected_answer + "</H1>" +
//                     "<H2>Press [Return] for next task<H2>");
//             },
//     });
// }
//
