...
export abstract class BinaryOperatorTree {
    ...
    is_commutative() {
        return this.constructor.name == "Sum" || this.constructor.name == "Multiplication";
    }
    ...
    number_of_divisions():number {
        let divisons = 0;
        if (this.constructor.name=="Division")
            divisons++;
    ...
    tree_string_to_array(arr:string[]) {
        let constr_name = "";
        if (this.constructor.name==="Multiplication")
            constr_name = "RMult";
        if (this.constructor.name==="Division")
            constr_name = "RDiv";
        if (this.constructor.name==="Difference")
            constr_name = "RDif";
        if (this.constructor.name==="Sum")
            constr_name = "RSum";
    ...
    // source_code_child_value(child: BinaryOperatorTree, kinds: string[]):number {
    //     if(child==null)
    //         return 1;
    //     if(child.is_of_one_kind(kinds)) {
    //         return child.source_code_value();
    //     } else {
    //         return 2 * child.source_code_value();
    //     }
    // }
    //
    // math_notation_child_value(child: BinaryOperatorTree, kinds: string[]):number {
    //     if(child==null)
    //         return 1;
    //     if(child.is_of_one_kind(kinds)) {
    //         return child.math_notation_value();
    //     } else {
    //         return 2 * child.math_notation_value();
    //     }
    // }
    ...
    // abstract source_code_value();
    // abstract math_notation_value();
    //
    // number_of_divisions():number {
    //     let ret = 0;
    //     if(this.constructor.name==="Division")
    //         ret++;
    //     if(this.left_math_term()!=null)
    //         ret = ret + this.left_math_term().number_of_divisions();
    //
    //     if(this.right_math_term()!=null)
    //         ret = ret + this.right_math_term().number_of_divisions();
    //
    //     return ret;
    // }
...
export class Multiplication extends BinaryOperatorTree {
    ...
    source_code_readability_value(depth:number) {
        ...
        if (this.left_math_term() != null) {
            if (this.left_math_term().constructor.name == "Sum") {
        ...
        if (this.right_math_term() != null) {
            if (this.right_math_term().constructor.name == "Sum" || this.right_math_term().constructor.name=="Division") {
...
//
//     // source_code_value() {
//     //     let ret = this.source_code_child_value(this.left_math_term(), ["Literal", "Sum", "Difference"]);
//     //     ret += this.source_code_child_value(this.right_math_term(), ["Literal"]);
//     //     return ret;
//     // }
//
//     source_code_readability_value() {
//         let left_value = 0;
//         let right_value = 0;
//
//         if(this.left_math_term()!=null) {
//             if(this.left_math_term().constructor.name=="Sum") {
//                 left_value = 2 + this.left_math_term().source_code_readability_value();
//             } else {
//                 left_value = this.left_math_term().source_code_readability_value();
//             }
//         }
//
//         if(this.right_math_term()!=null)
//             if(this.right_math_term().constructor.name=="Sum" || this.right_math_term().constructor.name=="Multiplication") {
//                 right_value = 2 + this.right_math_term().source_code_readability_value();
//             } else {
//                 right_value = this.right_math_term().source_code_readability_value();
//             }
//
//
//         return 1 + left_value + right_value;
//     }
//
//     math_readability_value() {
//         let left_value = 0;
//         let right_value = 0;
//
//         if(this.left_math_term()!=null)
//             left_value = this.left_math_term().math_readability_value();
//
//         if(this.right_math_term()!=null)
//             right_value = 2 * this.right_math_term().math_readability_value();
//
//         return 1 + left_value + right_value;
//     }
//
//     // math_notation_value() {
//     //     let ret = this.math_notation_child_value(this.left_math_term(), ["Literal", "Sum", "Difference", "Division"]);
//     //     ret += this.math_notation_child_value(this.right_math_term(), ["Literal", "Division"]);
//     //     return ret;
//     // }
//
//     mathjax_string_representation(solution_node: SolutionOnBinaryOperatorTree, result:string[]):void {
//         this.mathjax_child_with_no_brackets_on_kind(solution_node.children[0], result, ["Literal", "Division", "Sum", "Difference"]);
//         result.push(" - ");
//         this.mathjax_child_with_no_brackets_on_kind(solution_node.children[1], result, ["Literal", "Division"]);
//     }
// }
