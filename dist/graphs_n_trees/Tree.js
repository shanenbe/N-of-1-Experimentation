...
export function generate_flat_trees(number_of_children) {
    ...
    repeat(number_of_children - 1, (counter) => {
...
export function all_true_false_binary_trees(number_of_tree_nodes) {
    let all_binary_trees = generate_binary_trees(number_of_tree_nodes);
    let number_of_true_false_combinations = Math.pow(2, number_of_tree_nodes) - 1;
    let all_true_false_combinations_array = all_true_false_combinations(number_of_true_false_combinations);
...
export function generate_trees(number_of_nodes) {
    ...
    for (let p of partitions) {
        ...
        all_array_combinations(this_partition, e => {
            let children = [];
